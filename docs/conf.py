...
html_title = 'The SEAN\'s Guide to Linux Kdump Analysis'
...
htmlhelp_basename = 'kdumpguidedoc'
...
latex_documents = [
  ('index', 'kdumpguide.tex', u'Linux Kdump Guide Documentation',
   u'sean', 'manual'),
]
...
man_pages = [
    ('index', 'kdumpguide', u'Linux Kdump Guide Documentation',
     [u'sean'], 1)
]
